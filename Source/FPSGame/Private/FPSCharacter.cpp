...
void AFPSCharacter::Tick(float DeltaTime)
{
	...
	{
		FRotator new_rotation = CameraComponent->RelativeRotation;
		new_rotation.Pitch = RemoteViewPitch * 360.0f / 255.0f;
		CameraComponent->SetRelativeRotation(new_rotation);
	}
}
